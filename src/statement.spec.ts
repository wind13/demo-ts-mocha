...
import { renderPlainText, statement, renderHTML } from "./statement";
...
describe ('statement test suit', () => {
  it('should load js okay', () => {
    ...
    equal(renderPlainText(statement(invoices[0], plays)), result)
  });

  it ('should render html okay', () => {
    equal(renderHTML(statement(invoices[0], plays)), html)
  });
});
